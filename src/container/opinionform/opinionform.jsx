...
import { Companydata, Selectdata1, Selectdata2 } from '../apps/crm/companies/companiesdata';
...
const SecondOpnionForm = () => {
  ...
  <Fragment>
      <Pageheader currentpage="Second Opnion Form" activepage=" CRM" mainpage="Companies" />
...
export default SecondOpnionForm;
